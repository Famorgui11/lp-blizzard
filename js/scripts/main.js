...
const progressSlides = document.querySelector('.js-progress');

var slide_hero = new Swiper(".main-slide", {
    effect: 'fade',
    thumbs: {
    ...
    on: {
        init: function() {
            progressSlides.classList.remove('animate');
            progressSlides.classList.remove('active');
            progressSlides.classList.add('animate');
            progressSlides.classList.add('active');
        },
